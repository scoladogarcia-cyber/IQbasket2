-- =============================================================================
-- IQBasket V35 · Administrative RPC privilege boundary
--
-- Goal
--   Keep browser-facing administrative RPC signatures stable while moving the
--   privileged table mutations behind a non-exposed private implementation.
--
-- Security invariants
...
-- -----------------------------------------------------------------------------
-- 2. Role + contextual player assignment
-- -----------------------------------------------------------------------------
...
begin
  ...
  if v_role='JUGADOR' then
    if p_linked_player_id is null then
    ...
    if v_player_team is null then
      raise exception 'PLAYER_LINK_ROSTER_MEMBERSHIP_REQUIRED';
    end if;
...
-- -----------------------------------------------------------------------------
-- 3. Stable public API · all public functions are SECURITY INVOKER
-- -----------------------------------------------------------------------------
