...
select
  'PLAYER360_PHASE4C_APPLY' as section,
  ...
  to_regprocedure('public.iq_v4_save_player_evaluation(uuid,uuid,date,text,text,text,text,text,text,text,boolean,boolean,jsonb,jsonb,jsonb,uuid)') is not null as save_evaluation_rpc_ok,
  to_regprocedure('public.iq_v4_save_objective_profile(uuid,uuid,date,date,text,text,jsonb,jsonb,jsonb,uuid)') is not null as save_objective_rpc_ok,
  to_regprocedure('public.iq_v4_get_player_objective_gap(uuid)') is not null as gap_rpc_ok;
