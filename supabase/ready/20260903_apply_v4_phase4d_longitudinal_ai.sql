-- =============================================================================
-- IQBasket v4 · Phase 4D Longitudinal Analytics + AI Evidence · CONTROLLED APPLY
-- Date: 2026-09-03
--
-- Installs only Phase 4D persistence and authorization boundaries after successful preflight/rehearsal.
...
select
  'PLAYER360_PHASE4D_APPLY' as section,
  to_regclass('public.player_longitudinal_snapshots') is not null as snapshots_installed,
  to_regclass('public.player_ai_insights') is not null as insights_installed,
  to_regprocedure('public.iq_v4_can_generate_longitudinal_analytics(uuid)') is not null as generate_analytics_guard_installed,
  to_regprocedure('public.iq_v4_can_generate_ai_insights(uuid)') is not null as generate_ai_guard_installed,
  to_regprocedure('public.iq_v4_can_review_ai_insights(uuid)') is not null as review_ai_guard_installed;
