...
export class TranslationStore {
  static defaultDictionary = {
    es: {
      ...
      "approvals.subtitle": "Centraliza solicitudes operativas y muestra sólo las acciones permitidas por tu rol y contexto.",
    ...
    ca: {
      ...
      "approvals.subtitle": "Centralitza sol·licituds operatives i mostra només les accions permeses pel teu rol i context.",
    ...
    en: {
      ...
      "approvals.subtitle": "Centralizes operational requests and only exposes actions allowed by your role and context.",
    ...
    fr: {
      ...
      "approvals.subtitle": "Centralise les demandes opérationnelles et n’affiche que les actions autorisées par votre rôle et votre contexte.",
