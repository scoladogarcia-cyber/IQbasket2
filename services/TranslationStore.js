...
export class TranslationStore {
  static defaultDictionary = {
    es: {
      ...
      "approvals.resolution_note": "Nota de resolución (opcional)",
      "approvals.resolution_note_placeholder": "Añade contexto para la auditoría",
      "approvals.action_error": "No se pudo completar la acción.",
      "approvals.type_transfer": "Traspaso",
      "approvals.type_season_freeze": "Cierre de temporada",
      "approvals.season_freeze_title": "Cerrar temporada · {team}",
      "approvals.approve_season_freeze_confirm": "¿Aprobar el cierre de esta temporada? Sus partidos abiertos y la plantilla quedarán congelados en modo histórico.",
    ...
    ca: {
      ...
      "approvals.resolution_note": "Nota de resolució (opcional)",
      "approvals.resolution_note_placeholder": "Afegeix context per a l’auditoria",
      "approvals.action_error": "No s’ha pogut completar l’acció.",
      "approvals.type_transfer": "Traspàs",
      "approvals.type_season_freeze": "Tancament de temporada",
      "approvals.season_freeze_title": "Tancar temporada · {team}",
      "approvals.approve_season_freeze_confirm": "Aprovar el tancament d’aquesta temporada? Els partits oberts i la plantilla quedaran congelats en mode històric.",
    ...
    en: {
      ...
      "approvals.resolution_note": "Resolution note (optional)",
      "approvals.resolution_note_placeholder": "Add context for the audit trail",
      "approvals.action_error": "The action could not be completed.",
      "approvals.type_transfer": "Transfer",
      "approvals.type_season_freeze": "Season closure",
      "approvals.season_freeze_title": "Close season · {team}",
      "approvals.approve_season_freeze_confirm": "Approve this season closure? Open games and the roster will be frozen in historical read-only mode.",
    ...
    fr: {
      ...
      "approvals.resolution_note": "Note de résolution (facultative)",
      "approvals.resolution_note_placeholder": "Ajoutez du contexte pour l’audit",
      "approvals.action_error": "L’action n’a pas pu être effectuée.",
      "approvals.type_transfer": "Transfert",
      "approvals.type_season_freeze": "Clôture de saison",
      "approvals.season_freeze_title": "Clôturer la saison · {team}",
      "approvals.approve_season_freeze_confirm": "Approuver la clôture de cette saison ? Les matchs ouverts et l’effectif seront figés en mode historique.",
